...
def connexion():
    ...
    boite1.pack(pady=10, padx=20, fill="both", expand=True)
    ...
    def verifier_identifiants():
        ...
        if not username:
            messagebox.showerror("Champs manquants", "Le pseudo ne peut pas être vide !")
            return
        if not password:
        ...
        try:
            ...
            messagebox.showerror("Erreur", "Erreur de base de données lors de la connexion à ton compte !")
            return
