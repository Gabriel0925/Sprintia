...
# Version Sprintia
version_numéro = "3.2"
date_de_sortie = "23 Octobre 2025"
type_de_maj = "Mise à jour mineur"

# Couleur
couleur1 = "#366a9e" #366a9e #2f6192 #3d71a5
couleur1_hover = "#60a7ee" #4a8bcb
couleur2 = "#8CB1C1"
couleur2_hover = "#ABD1E1"
couleur_fond = "#131d34"
couleur_text = "#fbfcfb"

# Mode clair, palette de couleur verte
#couleur1 = "#3a763a"
#couleur1_hover = "#4ea24e"
#couleur2 = "#94c394"
#couleur2_hover = "#b9f4b9"
#couleur_fond = "#f0f0f0" 
#couleur_text = "#1f1f1f"

# Table pour base de données
# !!! Tjrs rajouter les tables à la fin ! Pour la boucle for pour la suppresion de compte !!!
table_bdd = ["Account", "Historique_activité", "Compétition", "Objectif", "Pauses", 
             "Maj_base_de_donnée", "Maj_base_de_donnée2", "Auto_connect", "Coach"]
