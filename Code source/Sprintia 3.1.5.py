...
# Maj
numérotation_version = "3.1.5"
date_version = ""
date_de_sortie_maj = "21 Octobre 2025"
type_maj = "Patch mineur" 
version_numéro = "3.1.5"
version_entière = "3.1.5"
date_de_sortie = "21 Octobre 2025"
type_de_maj = "Patch mineur"  
...
🐛 Corrections de bugs et optimisation
    • Correction de quelques problèmes d'interface.
    • Nouvelle interface dans "quoi de neuf" et "à propos".
    • Sprintia est désormais une application en .exe.
    """
    , justify="left")
...
def connexion():
    ...
    username_entry = ctk.CTkEntry(master=carte_connexion, placeholder_text="Pseudo", border_color=couleur1, fg_color=couleur1,
                                  height=entry_height, font=(font_principale, taille3), corner_radius=corner1, placeholder_text_color ="white",
                                  text_color="white")
    username_entry.pack(fill="x", pady=(12, 5), padx=12)
    password_entry = ctk.CTkEntry(master=carte_connexion, placeholder_text="Mot de passe", show="*", border_color=couleur1,fg_color=couleur1,
                                  height=entry_height, font=(font_principale, taille3), corner_radius=corner1, placeholder_text_color ="white",
                                  text_color="white")
    password_entry.pack(fill="x", pady=(0, 12), padx=12)
...
def inscription():
    ...
    password_entry = ctk.CTkEntry(master=carte_inscription, placeholder_text="Mot de passe", show="*", border_color=couleur1,fg_color=couleur1,
                                  height=entry_height, font=(font_principale, taille3), corner_radius=corner1, placeholder_text_color ="white",
                                  text_color="white")
    password_entry.pack(fill="x", pady=(0, 5), padx=12)
