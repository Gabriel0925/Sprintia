...
def installation_des_bibliothèques():
    bibliothèques = [sys.executable, "-m", "pip", "install", "customtkinter", "matplotlib", "seaborn", "pillow", "tkcalendar"]
    try:
...
def hello():                
    ...
    if reponse:
        ...
        messagebox.showwarning("Attention", "Si tu refuses, tu risques de ne même pas pouvoir ouvrir Sprintia. Relance le programme, si tu veux installer les bibliothèque nécessaire à Sprintia.")
